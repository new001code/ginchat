...
func init() {
	common.Logger.Info("start redis init")
	redisInit()
	common.Logger.Info("end redis init")
}
...
func (ru *RedisUtil) GetString(k string) string {
	...
	if err != nil {
		common.Logger.Error("RedisUtil GetString err: ", err)
	}
	return str
}
...
func (ru *RedisUtil) SetString(key string, value string, expiration time.Duration) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil SetString err: ", err)
	}
}
...
func (ru *RedisUtil) GetSetString(k string, v string) string {
	...
	if err != nil {
		common.Logger.Error("RedisUtil GetSetString err: ", err)
	}
	return oldValue
}
...
func (ru *RedisUtil) SetIfNilString(k string, v any, expiration time.Duration) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil SetIfNilString err: ", err)
	}
}
...
func (ru *RedisUtil) GetByManyKey(k ...string) []any {
	...
	if err != nil {
		common.Logger.Error("RedisUtil GetByManyKey err: ", err)
	}
	return vals
}
...
func (ru *RedisUtil) SetManyKeyValue(k ...any) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil SetManyKeyValue err: ", err)
	}
}
...
func (ru *RedisUtil) Incr(k string) int64 {
	...
	if err != nil {
		common.Logger.Error("RedisUtil Incr err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) IncrBy(k string, v int64) int64 {
	...
	if err != nil {
		common.Logger.Error("RedisUtil IncrBy err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) IncrByFloat(k string, v float64) float64 {
	...
	if err != nil {
		common.Logger.Error("RedisUtil IncrByFloat err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) Decr(k string) int64 {
	...
	if err != nil {
		common.Logger.Error("RedisUtil Decr err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) DecrBy(k string, v int64) int64 {
	...
	if err != nil {
		common.Logger.Error("RedisUtil DecrBy err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) SetHash(hashKey string, k, v any) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil SetHash err: ", err)
	}
}
...
func (ru *RedisUtil) GetHashValue(hashKey string, k string) string {
	...
	if err != nil {
		common.Logger.Error("RedisUtil GetHashValue err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) GetAllHashValue(hashKey string) map[string]string {
	...
	if err != nil {
		common.Logger.Error("RedisUtil GetAllHashValue err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) HashIncrBy(hashKey string, k string, v int64) int64 {
	...
	if err != nil {
		common.Logger.Error("RedisUtil HashIncrBy err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) HashIncrByFloat(hashKey string, k string, v float64) float64 {
	...
	if err != nil {
		common.Logger.Error("RedisUtil HashIncrByFloat err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) HashAllFieldKeys(hashKey string) []string {
	...
	if err != nil {
		common.Logger.Error("RedisUtil HashAllFieldKeys err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) HashFieldNum(hashKey string) int64 {
	...
	if err != nil {
		common.Logger.Error("RedisUtil HashFieldNum err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) HashManyGet(hashKey string, k ...string) []any {
	...
	if err != nil {
		common.Logger.Error("RedisUtil HashManyGet err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) HashManySet(hashKey string, v any) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil HashManySet err: ", err)
	}
}
...
func (ru *RedisUtil) HashSetIfNil(hashKey string, k string, v any) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil HashSetIfNil err: ", err)
	}
}
...
func (ru *RedisUtil) HashExists(hashKey string, k string) bool {
	...
	if err != nil {
		common.Logger.Error("RedisUtil HashExists err: ", err)
	}
	return exist
}
...
func (ru *RedisUtil) LRush(key string, v ...any) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil LRush err: ", err)
	}
}
...
func (ru *RedisUtil) LPushX(key string, v ...any) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil LRushX err: ", err)
	}
}
...
func (ru *RedisUtil) RPop(key string) string {
	...
	if err != nil {
		common.Logger.Error("RedisUtil RPop err: ", err)
	}
	return val
}
func (ru *RedisUtil) RRush(key string, v ...any) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil RPush err: ", err)
	}
}
...
func (ru *RedisUtil) RPushX(key string, v ...any) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil RRushX err: ", err)
	}
}
...
func (ru *RedisUtil) LPop(key string) string {
	...
	if err != nil {
		common.Logger.Error("RedisUtil LPop err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) LLen(key string) int64 {
	...
	if err != nil {
		common.Logger.Error("RedisUtil LLen err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) LRange(key string, start, stop int64) []string {
	...
	if err != nil {
		common.Logger.Error("RedisUtil LRange err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) LRem(key string, count int64, v any) int64 {
	...
	if err != nil {
		common.Logger.Error("RedisUtil LRem err: ", err)
	}
	return dels
}
...
func (ru *RedisUtil) LIndex(key string, v int64) string {
	...
	if err != nil {
		common.Logger.Error("RedisUtil LIndex err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) LInsertAfter(key string, ikey any, v any) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil LInsertAfter err: ", err)
	}
}
...
func (ru *RedisUtil) LInsertBefore(key string, ikey any, v any) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil LInsertBefore err: ", err)
	}
}
...
func (ru *RedisUtil) SAdd(key string, v ...any) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil SAdd err: ", err)
	}
}
...
func (ru *RedisUtil) SNum(key string) int64 {
	...
	if err != nil {
		common.Logger.Error("RedisUtil SNum err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) SContain(key string, v any) bool {
	...
	if err != nil {
		common.Logger.Error("RedisUtil SContain err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) SMembers(key string) []string {
	...
	if err != nil {
		common.Logger.Error("RedisUtil SMembers err: ", err)
	}
	return val
}
...
func (ru *RedisUtil) SRem(key string, v ...any) {
	...
	if err != nil {
		common.Logger.Error("RedisUtil SRem err: ", err)
	}
}
...
func (ru *RedisUtil) SPopN(key string, n int64) []string {
	...
	if err != nil {
		common.Logger.Error("RedisUtil SPopN err: ", err)
	}
	return vals
}
